...
if(!in_array($type2, $tipe_diizinkan)){
  ...
  move_uploaded_file($tmp_name, './public/images/card/'. $newname);
...
<select class="w-full p-2"  name="category" id="category" required>
...
<input type="text" name="nama" class="w-full mt-5" placeholder="Nama Produk" required >
<input type="text" name="harga" class="w-full mt-5" placeholder="Harga" required >
<input class="w-full mt-5" type="file" name="gambar" id="gambar" accept="image/*"  required >
<textarea name="deskripsi" id="" cols="30" rows="5" class="w-full mt-5" placeholder="Deskripsi Produk" ></textarea>
