        ...
        <tbody class="bg-white divide-y divide-gray-200">
          ...
          <tr>
            ...
            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
              <a href="edit-category.php?id=<?php echo $row['category_id']?>" class="text-indigo-600 hover:text-indigo-900">Edit</a> || <a href="proses-hapus.php?idk=<?php echo $row['category_id']?>" onclick="return confirm('Yakin ingin menghapus?')" class="text-indigo-600 hover:text-indigo-900" >Hapus</a>
            </td>
          </tr>
          <?php } ?>
